...
public class DashboardView extends BorderPane {
    public DashboardView(ClubDeportivo club) throws SQLException {
        ...
        //esto lo añado por estética.
        TableColumn<Socio, String> c3 = new TableColumn<>("Apellido");
        c3.setCellValueFactory(p -> new javafx.beans.property.SimpleStringProperty(p.getValue().getApellidos()));

        tablaSocios.getColumns().addAll(c1, c2, c3);
        ...
        //Ha sido un gran quebradero de cabeza añadir el Deporte a la vista.
